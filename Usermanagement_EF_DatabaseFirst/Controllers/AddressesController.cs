...
namespace Usermanagement_EF_DatabaseFirst.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "AddressID,Address1,City,PostalCode,ProvinceID")] Address address)
        {
            ...
            ViewBag.ProvinceID = new SelectList(db.Provinces, "ProvinceID", "ProvinceName", address.ProvinceID);
            return View(address);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "AddressID,Address1,City,PostalCode,ProvinceID")] Address address)
        {
            if (ModelState.IsValid)
            {
